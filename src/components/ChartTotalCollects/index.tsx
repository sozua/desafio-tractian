...
const ChartTotalCollects = (props: HighchartsReact.Props) => {
  ...
  useEffect(() => {
    const series = data.map((asset: AssetProps) => {
      const totalCollectUptime = asset.metrics.totalCollectsUptime;
      const assetName = asset.name;
      return { name: assetName, data: [totalCollectUptime] };
    });
...
export default ChartTotalCollects;
